...
% ----------------------------------------------------------
% Timecourse preview (top) - similar to PCA
% ----------------------------------------------------------
axPrev = axes('Parent',rightPanel,'Units','normalized','Position',[0.10 0.66 0.82 0.20], ...
    'Color',bgAx,'XColor',fgDim,'YColor',fgDim);
title(axPrev,'Preview','Color',fg,'FontWeight','bold');
grid(axPrev,'on');

% ----------------------------------------------------------
% Spatial map preview moved more left
% ----------------------------------------------------------
axMap = axes('Parent',rightPanel,'Units','normalized','Position',[0.10 0.42 0.54 0.18], ...
    'Color',bgAx,'XColor',fgDim,'YColor',fgDim);
title(axMap,'Spatial Weight Preview','Color',fg,'FontWeight','bold');

% ----------------------------------------------------------
% Small display controls next to spatial preview
% ----------------------------------------------------------
uicontrol('Parent',rightPanel,'Style','text','Units','normalized', ...
    'Position',[0.68 0.58 0.24 0.035], ...
    'String','Map Display', ...
...
contrastSlider = uicontrol('Parent',rightPanel,'Style','slider', ...
    'Units','normalized','Position',[0.68 0.51 0.18 0.03], ...
    'Min',0.5,'Max',3.0,'Value',1.8, ...
...
contrastValueText = uicontrol('Parent',rightPanel,'Style','text','Units','normalized', ...
    'Position',[0.87 0.505 0.05 0.035], ...
    'String','1.80', ...
    'BackgroundColor',get(rightPanel,'BackgroundColor'), ...
...
gammaSlider = uicontrol('Parent',rightPanel,'Style','slider', ...
    'Units','normalized','Position',[0.68 0.44 0.18 0.03], ...
    'Min',0.30,'Max',1.50,'Value',0.65, ...
    'BackgroundColor',[0.18 0.18 0.19], ...
    'Callback',@updateSpatialControls);

gammaValueText = uicontrol('Parent',rightPanel,'Style','text','Units','normalized', ...
    'Position',[0.87 0.435 0.05 0.035], ...
    'String','0.65', ...
    'BackgroundColor',get(rightPanel,'BackgroundColor'), ...
    'ForegroundColor',[0.70 0.90 1.00], ...
    'HorizontalAlignment','right', ...
...
mapDropdown = uicontrol('Parent',rightPanel,'Style','popupmenu', ...
    'Units','normalized','Position',[0.68 0.37 0.24 0.035], ...
    'String',{'hot','gray','parula','jet'}, ...
    'Value',1, ...
    'BackgroundColor',[0.18 0.18 0.19], ...
    'ForegroundColor',fg, ...
    'FontSize',9, ...
...
uicontrol('Parent',rightPanel,'Style','text','Units','normalized', ...
    'Position',[0.10 0.29 0.82 0.04], 'String','Selected for removal:', ...
...
uiwait(fig);
    ...
    function refreshSpatialPreview()
        ...
        axis(axMap,'image');
        axis(axMap,'off');
        title(axMap, currentMapTitle, 'Color', fg, 'FontWeight','bold');
