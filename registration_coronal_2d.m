...
%   - improved GUI layout: larger control panel, larger fonts, tighter spacing
%
% Saved files:
...
fig = figure( ...
    ...
    'ToolBar','none', ...
    'NumberTitle','off', ...
    'Position',[60 40 1600 960], ...
    'Resize','off', ...
    'CloseRequestFcn',@onClose);

axAtlas = axes('Parent',fig,'Units','normalized','Position',[0.025 0.12 0.255 0.78], ...
    'Color','k');
axis(axAtlas,'image');
axis(axAtlas,'off');

axFuse = axes('Parent',fig,'Units','normalized','Position',[0.300 0.12 0.255 0.78], ...
    'Color','k');
axis(axFuse,'image');
axis(axFuse,'off');

uicontrol('Style','text','Parent',fig,'Units','normalized', ...
    'Position',[0.025 0.92 0.53 0.04], ...
    'BackgroundColor',bg, ...
    'ForegroundColor',fg, ...
...
uicontrol('Style','text','Parent',fig,'Units','normalized', ...
    'Position',[0.025 0.885 0.255 0.028], ...
    'BackgroundColor',bg, ...
    'ForegroundColor',fg, ...
...
uicontrol('Style','text','Parent',fig,'Units','normalized', ...
    'Position',[0.300 0.885 0.255 0.028], ...
    'BackgroundColor',bg, ...
    'ForegroundColor',fg, ...
    'HorizontalAlignment','center', ...
    'FontSize',FS.section-1, ...
...
uicontrol('Style','text','Parent',fig,'Units','normalized', ...
    'Position',[0.025 0.025 0.53 0.05], ...
    'BackgroundColor',bg, ...
...
uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
    'Position',[xLbl 0.890 wLbl hText], ...
    'String','Mode', ...
    'BackgroundColor',panelBG, ...
    'ForegroundColor',fg, ...
    'HorizontalAlignment','left', ...
...
hMode = uicontrol('Style','popupmenu','Parent',ctrl,'Units','normalized', ...
    'Position',[xEdit 0.892 0.36 hEdit], ...
    'String',atlasModes, ...
    'Value',modeIdx, ...
...
uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
    'Position',[xLbl 0.845 wLbl hText], ...
    'String','Slice', ...
    'BackgroundColor',panelBG, ...
    'ForegroundColor',fg, ...
    'HorizontalAlignment','left', ...
...
hSliceEdit = uicontrol('Style','edit','Parent',ctrl,'Units','normalized', ...
    'Position',[xEdit 0.847 0.12 hEdit], ...
...
uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
    'Position',[xLbl 0.730 wLbl hText], ...
    'String','Opacity', ...
    'BackgroundColor',panelBG, ...
    'ForegroundColor',fg, ...
    'HorizontalAlignment','left', ...
...
hOpacity = uicontrol('Style','slider','Parent',ctrl,'Units','normalized', ...
    'Position',[xEdit 0.736 0.61 hSl], ...
    'Min',0,'Max',1,'Value',S.opacity, ...
    'Callback',@onOpacity);

uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
    'Position',[xLbl 0.683 0.16 hText], ...
    'String','Win min', ...
    'BackgroundColor',panelBG, ...
    'ForegroundColor',fg, ...
    'HorizontalAlignment','left', ...
...
hWinMin = uicontrol('Style','edit','Parent',ctrl,'Units','normalized', ...
    'Position',[xEdit 0.685 wEditSmall hEdit], ...
...
uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
    'Position',[0.56 0.683 0.16 hText], ...
    'String','Win max', ...
    'BackgroundColor',panelBG, ...
    'ForegroundColor',fg, ...
    'HorizontalAlignment','left', ...
...
hWinMax = uicontrol('Style','edit','Parent',ctrl,'Units','normalized', ...
    'Position',[0.74 0.685 wEditSmall hEdit], ...
...
uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
    'Position',[xLbl 0.638 wLbl hText], ...
    'String','Colormap', ...
    'BackgroundColor',panelBG, ...
    'ForegroundColor',fg, ...
    'HorizontalAlignment','left', ...
...
hCmap = uicontrol('Style','popupmenu','Parent',ctrl,'Units','normalized', ...
    'Position',[xEdit 0.640 0.36 hEdit], ...
    'String',cmaps, ...
    'Value',cmapIdx, ...
    'BackgroundColor',panelBG2, ...
    'ForegroundColor',fg, ...
...
hInvert = uicontrol('Style','checkbox','Parent',ctrl,'Units','normalized', ...
    'Position',[xChk 0.640 0.18 hEdit], ...
    'String','Invert', ...
...
uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
    'Position',[0.05 0.222 0.90 0.035], ...
...
uicontrol('Style','pushbutton','Parent',ctrl,'Units','normalized', ...
    'Position',[0.28 0.095 0.22 0.055], ...
    'String','Save Reg', ...
...
uicontrol('Style','pushbutton','Parent',ctrl,'Units','normalized', ...
    'Position',[0.53 0.095 0.27 0.055], ...
...
uicontrol('Style','pushbutton','Parent',ctrl,'Units','normalized', ...
    'Position',[0.83 0.095 0.12 0.055], ...
    'String','Close', ...
...
hStatus = uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
    'Position',[0.05 0.030 0.90 0.045], ...
    'String','', ...
    'BackgroundColor',panelBG, ...
...
uiwait(fig);
    ...
    function [hTx, hTy, hRot, hSx, hSy] = createTransformRows()
        ...
        function hRow = makeRow(lbl, val, y, cbEdit, cbMinus, cbPlus)
            uicontrol('Style','text','Parent',ctrl,'Units','normalized', ...
                'Position',[xLbl y+0.005 wLbl hText], ...
                'String',lbl, ...
                'BackgroundColor',panelBG, ...
                'ForegroundColor',fg, ...
                'HorizontalAlignment','left', ...
...
for i = 1:numel(modes)
    ...
    if strcmpi(modeName,'regions')
        ...
        % IMPORTANT:
        % Use RGB as brainImage so older SCM loaders display the regions in color.
        brainImage = atlasUnderlayRGB; %#ok<NASGU>

        % Keep numeric labels separately for lookup / segmentation
        ...
        % Optional text export of present regions
        try
        ...
        % vascular / histology keep numeric grayscale as brainImage
